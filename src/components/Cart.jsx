...
import { selectCartItems, selectCartState, setCloseCart, setClearCartItems, setGetTotals, selectTotalAmount, selectTotalQTY } from '../app/CartSlice.js'
    ...
    return (
        <>
            <div className={`fixed top-0 left-0 right-0 bottom-0 blur-effect-theme w-full h-screen opacity-100 z-[250] ${ifCartState
                ...
                <div className={`blur-effect-theme h-screen max-w-xl w-full absolute right-0 ${ifCartState
                    ? "opacity-100 visible translate-x-0"
                    : "opacity-0 invisible translate-x-8"
                    }`}>
                    <CartCount totalQTY={totalQTY} onCartToggle={onCartToggle} clearCart={clearCart} />
